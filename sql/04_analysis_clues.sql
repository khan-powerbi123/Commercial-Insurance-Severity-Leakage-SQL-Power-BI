...
--Or the claim is old but still “open.”
 ...
 -- → could mean reserve drift, stalled claim handling, or potential leakage (more money than necessary locked in reserves).
 ...
 SELECT
	...
	--The query returned no results, which suggests the dataset is free of duplicate disbursements under those criteria. In other words, our payment data looks clean.
